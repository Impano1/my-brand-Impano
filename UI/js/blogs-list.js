document.addEventListener("DOMContentLoaded", () => {
  ...
  const baseURL = "https://mybrand-api-backend.onrender.com";
  fetch(baseURL + "/blogs")
    .then((response) => {
      if (!response.ok) {
    ...
    .then((data) => {
      ...
      data.forEach((blog) => {
        ...
        tr.innerHTML = `
                    ...
                    <td>
                        <button onclick="editBlog('${blog._id}')"><i class="bx bxs-edit-alt"></i></button>
                        <button onclick="deleteBlog('${blog._id}')"><i class="bx bx-trash"></i></button>
                    </td>
                `;
...
function editBlog(blogId) {
  ...
  if (updateForm) {
    ...
    const baseURL = "https://mybrand-api-backend.onrender.com"; // Define baseURL
